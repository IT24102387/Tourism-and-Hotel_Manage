...
import {
    ...
    getRoomCancelledNotifications, markRoomNotificationRead
...
roomRouter.get("/bookings/cancelled-notifications",              getRoomCancelledNotifications);
roomRouter.patch("/bookings/:bookingId/mark-notified",           markRoomNotificationRead);
